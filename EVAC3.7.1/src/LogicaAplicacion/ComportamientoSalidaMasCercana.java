...
public class ComportamientoSalidaMasCercana extends Comportamiento {
    ...
    public boolean ejecutarComportamiento(AutomataCelular ac, AutomataCelular ac2, AutomataCelular acAmbiente, Point nodo) {
        ...
        if ( this.getVecinos().size()>0 && (ac.getCelda(nodo.y, nodo.x).getAgente().getContadorVelocidad() < ac.getCelda(nodo.y, nodo.x).getAgente().getVelocidad()) ) {
            ...
            try {
                ...
                if((this.puertaMasCercana(nodo, ac)-1 ) ==-1){
                   ...
                   ac.getCelda(nodo.y, nodo.x).getAgente().setSalidaElegida(this.puertaMasCercana(nodo, ac));
                   ((Contador)ThreadSimulacion.intenciones.get( this.puertaMasCercana(nodo, ac)-1 )).incrementarContador();
                    
                }
            }
            catch (Exception ex) {
                System.out.println(this.puertaMasCercana(nodo, ac));
